...
* SSD: WD_BLACK SN850X 1000GB NVME M2 (PCI-e 4.0) - macOS Sequoia 15.4.1 (24E263)
* SSD: WD_BLACK SN850X 1000GB NVME M2 (PCI-e 4.0) - Windows 11
* SSD: Samsung 860 EVO 500GB (SATA-6 AHCI) - macOS Ventura 13.7.4 (22H420)
...
### Mac OS Sequoia with EFI OpenCore loader 1.0.4 and Clover 5161 + legacy Broadcom WiFi + OCLP patch 2.2.0
